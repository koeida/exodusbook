...
Ēgressus est post hæc vir dē domō Levī: et accēpit uxōrem \mpp{stirps, stirpis (m/f):}{stricto sensu est truncus arboris, ergo etiam origo est generis in familiis}stirpis suæ.
...
\mpp{līnere:}{rem aliquam liquidam aut mollem alteri superinducere}
\mpp{bitūmen, -inis(n):}{limus pinguis et sulphureus ē terrā emergens pluribus locīs}
\mpp{pix, picis (f):}{rēs ātra quae fit ex liquōre crassō arborum coctō}
...
posuitque intus īnfantulum, et \mpp{cārectum, -ī (n):}{locus caricibus plenus}exposuit eum in cārectō \mpp{rīpa, -ae (f):}{terra tangēns flumen}rīpæ flūminis,
stante procul sorōre eius, et cōnsīderante \mpp{cōnsīderāns ēventum reī:}{exspectans ut videat quid futurum sit}ēventum reī.
Ecce autem dēscendēbat fīlia Pharaōnis ut lavārētur in flūmine.\mpp{crepīdo, -inis (f):}{ripa fluminis lapidibus sternebatur}\mpp{alveus, -ī (m):}{fossa, per quam fluvius defluit} Et puellæ eius \mpp{gradī:}{gradum facere, ambulāre}gradiēbantur per crepīdinem alveī.
...
\mpp{abscondere:}{rem aliquam aliquo in loco ponere, ut celetur}
\mpp{sabulum, -ī:}{res ex quā terra facta est in terrīs ubi imber paene numquam cadit}percussum Ægyptium abscondit sabulō.
...
\mpp{prīnceps, prīncipis (m):}{rex; dux}Quī respondit: ``Quis tē cōnstituit prīncipem et \mimg{judge.png}{\hspace*{0.75cm}iūdex, iūdicis (m/f)}iūdicem super nōs?
...
\mpp{īnsuper: praeterea}īnsuper et hausit aquam nōbīscum, pōtumque dedit ovibus.''
...
\mpp{pangō, pangere, pepigisse, pactum:}{constituere, statuere}ac recordātus est fœderis quod pepigit cum Abraham, Isaac et Iācōb.
