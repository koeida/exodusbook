...
\vnum{1}Locūtusque est Dominus ad Moysen, dīcēns: \vnum{2}
``\mpp{sānctificāre:}{sanctum facere}Sānctificā mihi omne \mpp{prīmōgenitus/a/um:}{quī vel quae prīmus natus est}prīmōgenitum quod
aperit \mpp{vulva, -ae (f):}{pars corporis feminae ubi infans crescit
antequam paritur}\mpp{aperīre vulvam: parī} vulvam in fīliīs Isrāēl, tam dē
...
\mpp{solemnitas:}{dies qui certis temporibus quotannis fit quo homines deum
...
huiuscemodī cultum statūtō tempore ā diēbus in diēs. \vnum{11}Cumque intrōdūxerit
...
\mpp{recordātiō, -ōnis (f):}{actus cogitandī dē aliquā memoriā}recordātiōnem, inter
...
quæ \mpp{vīcīnus/a/um:}{prope habitans}vīcīnā est: \mpp{????}{????}reputāns nē forte
