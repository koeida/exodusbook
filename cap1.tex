...
\mktitle{Capitulum Primum}
    ...
    \mpp{germināre:}{emittere germina (ea quae ex plantīs veniunt: semen, fructus, cēt.)}\mpp{quasi germinantēs:}{non vero germinantēs (quia hominēs non germinant) sed vidērī aliquō modō germināre}[In Aegyptō] fīliī Isrāēl crēvērunt, et quasi germinantēs \mpp{multiplicāre:}{multum facere; augēre}multiplicātī sunt:
...
Venīte, \mpp{sapienter (adv) <}{sapiēns}\mpp{opprimere:}{efficere ut aliquis surgere nōn potest}\mpp{ingruere:}{cum vi accedere}sapien\-ter opprimāmus eum, nē forte multiplicētur: et sī ingruerit contrā nōs bellum, addātur inimīcīs nostrīs, expugnātisque nōbīs ēgrediātur dē terrā.''
