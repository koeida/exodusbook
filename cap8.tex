\invisiblechapter{Cap. VIII}

\titleimg{frogtitle}

\mktitle{Capitulum Octāvum}
\thispagestyle{empty}
...
\mimg{furnus.png}{furnus, -ī (m)}furnōs tuōs, et in reliquiās cibōrum tuōrum:
\vnum{4}et ad tē, et ad populum tuum, \mpp{reliquiae, -ārum (f):}{pauca illa quae ex aliquā rē relicta sunt}et ad omnēs servōs tuōs intrābunt
rānæ.''
...
Dominus ad Moysēn:\linebreak\mpp{cōnsurgere:}{surgere}``Cōnsurge
