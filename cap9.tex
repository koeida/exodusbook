...
deo}sacrificet mihi.  \vnum{2}Quod sī adhūc \mpp{renuere:}{capite significāre sē nolle vel nōn agiturum aliquid}renuis, et retinēs
...
cōram Pharaōne.  \vnum{9}Sitque \mpp{pulvis, pulveris (f):}{terra minima et non
...
et populum tuum peste, perībisque dē terrā.  \mpp{idcirco:}{propterea, ideo}\vnum{16}Idcircō autem posuī tē, ut ostendam in tē \mpp{fortitudō, -inis (f):}{quod homo fortis habet}fortitūdinem
...
fundāta est, usque in præsēns tempus.  \vnum{19}Mitte ergō iam nunc, et
...
\vnum{31}Linum \mpp{linum, -ī (n):}{herba utilis ad vestimenta facienda}ergō et \mpp{hordeum, -ī (n)}{genus frumentī}hordeum læsum est, eō quod
