...
\vnum{1}Tunc cecinit Moysēs et fīliī Isrāēl
...
{\it
    ...
    \vnum{2}\mpp{fortitudo, -inis (f):}{quod homo fortis habet}Fortitūdō mea, et laus mea Dominus,\\
    ...
    dēposuistī \mpp{arversārius/a/um:}{qui est ante seu contra nos positus}adversāriōs tuōs:\\
    mīsistī īram tuam,\\
    ...
    congregātā sunt abyssī in mediō marī.
...
et dēvorāvit eōs terra.
    ...
    \vnum{13}Dux fuistī in \mpp{misericordia, -ae (f):}{quod sentimus dum vidēmus alium patī}misericordiā tuā\\
    populō quem redēmistī:\\
    et portāstī eum in fortitūdine tuā,\\
    ad \mpp{habitaculum, -ī (n):}{locus in quo aliquis habitat}habitāculum \mpp{sanctus:}{deo pertinens}sānctum tuum.
...
\mpp{robustus/a/um:}{durus, rigidus, valens}rōbustōs Moab obtinuit tremor:\\
...
in \mpp{magnitudo:}{quam magnum aliquid est}magnitūdine \mpp{brachium, -ī (n):}{bracchium}brāchiī tuī:\\
...
\mpp{sānnctuārium, -ī (n):}{sacer locus}sānctuārium tuum, Domine,\\
...
Sūmpsit ergō Maria prophētissa, soror Aarōn, \mimg{tymp}{tympanum, -ī (n)}tympanum in
